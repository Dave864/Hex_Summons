...
## Tracks the effects that modify the movement stat.
##
## Movement can be changed or set. Setting the value overrides all other
## changes. There should only be one effect, "Ensnare", that sets the movement
## to a specific value.
