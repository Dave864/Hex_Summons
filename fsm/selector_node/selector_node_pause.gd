...
## the need for another movement tile selection arises. When a player's turn
## ends, the Selector goes into the 'Wait' state. If the Selector is needed
## again to select a movement destination, it goes back to the 'SelectMove' state.
